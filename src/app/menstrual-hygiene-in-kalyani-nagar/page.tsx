...
export default function MenstrualHygienePage() {
  ...
  const selfCareGuidelines = [
    ...
    { 
      ...
      description: "Keeping a regular period log tracking cycle dates, flow volume, and cramp severity to help Dr. Deepika Lalwani construct an accurate diagnostic map.", 
  ...
  const journeySteps = [
    {
      ...
      description: 'A private consultation with Dr. Deepika Lalwani to review cycle patterns, bleeding duration, flow volumes, and to discuss any specific lifestyle habits or symptoms.',
  ...
  return (
    <>
      ...
      <main>
          ...
          <div className="container mx-auto px-4 max-w-[960px]">
            ...
            <div>
              ...
              <div className="text-text space-y-4 leading-relaxed mb-[30px]">
                ...
                <p>
                  At <strong>Dr. Deepika Lalwani's Clinic</strong>, recognized as a leading center for adolescent health and hormonal balance in Kalyani Nagar and Wadgaon Sheri, Pune, we believe in breaking the silence and myths surrounding menstruation. Dr. Deepika Lalwani provides highly informative, private consultations on proper hygiene, menstrual disorders, PCOD/PCOS cycle regulation, and pelvic wellness.
                </p>
                <p>
                  Our clinic is run single-handedly by Dr. Deepika Lalwani, ensuring that you receive direct, personal, and supportive medical guidance at every visit. We coordinate all menstrual wellness checkups strictly by prior appointment during dedicated hours, maintaining a quiet, highly sterilized environment that eliminates anxiety and public waiting room stress.
                </p>
              </div>
        ...
        {/* === SECTION 6: Why Choose Dr. Deepika Lalwani's Clinic for Menstrual Hygiene & Health? (White bg) === */}
        <section className="py-[60px] lg:py-[80px] bg-white">
          <div className="container mx-auto px-4 max-w-[960px]">
            ...
            <div className="bg-[#151722] text-white rounded-[24px] p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
              ...
              <div className="w-full md:w-[65%] lg:w-[70%] flex flex-col gap-6 relative z-10">
                <h3 className="text-[26px] font-bold text-white leading-tight">
                  Why Choose Dr. Deepika Lalwani's Clinic for Menstrual Hygiene & Health?
                </h3>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-white/80 text-[14px]">You consult Dr. Deepika Lalwani personally at every session. Sensitive details about cycle tracking, infection symptoms, and pelvic pain are discussed in a strictly confidential space.</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-accent mt-1 shrink-0" />
