  ...
  const careProtocol = [
    {
      ...
      description: 'A quiet clinical consult with Dr. Deepika Lalwani to review childbearing history, current lifestyle, spacing preferences, and future child goals in a private space.',
    ...
    },
    {
      ...
      description: 'Dr. Deepika Lalwani details the success rates, duration of action, side effects, and correct usage of selected contraceptive spacing or permanent options.',
  ...
  return (
    <>
      ...
      <main>
          ...
          <div className="container mx-auto px-4 max-w-[960px]">
            ...
            <div>
              ...
              <div className="text-text space-y-4 leading-relaxed mb-[30px]">
                ...
                <p>
                  At <strong>Dr. Deepika Lalwani's Clinic</strong>, the leading family planning and postpartum wellness center in Kalyani Nagar and Wadgaon Sheri, Pune, we believe that reproductive care should be supportive, private, and tailored to your medical history. Dr. Deepika Lalwani offers gentle, professional, and non-judgmental counseling, helping you select spacing methods that fit your career, physical recovery, and lifestyle goals.
                </p>
                <p>
                  Our clinic is run single-handedly by Dr. Deepika Lalwani, ensuring you receive direct, personal, and highly confidential care. We coordinate all family planning and outpatient procedures strictly by prior appointment during dedicated hours, maintaining a quiet, highly sterilized environment that eliminates anxiety and public lobby wait times.
                </p>
              </div>
        ...
        <section className="py-[60px] lg:py-[80px] bg-white">
          <div className="container mx-auto px-4 max-w-[1320px]">
            ...
            <p className="text-text mb-[50px] text-[15px] leading-relaxed text-center max-w-[700px] mx-auto">
              Depending on where you are in your family journey, Dr. Deepika Lalwani will help you evaluate temporary spacing options versus permanent surgical solutions.
            </p>
        ...
        {/* === SECTION 6: Why Choose Dr. Deepika Lalwani's Clinic for Family Planning? (White bg) === */}
        <section className="py-[60px] lg:py-[80px] bg-white">
          <div className="container mx-auto px-4 max-w-[960px]">
            ...
            <div className="bg-[#151722] text-white rounded-[24px] p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
              ...
              <div className="w-full md:w-[65%] lg:w-[70%] flex flex-col gap-6 relative z-10">
                <h3 className="text-[26px] font-bold text-white leading-tight">
                  Why Choose Dr. Deepika Lalwani's Clinic for Family Planning?
                </h3>
                ...
                <div className="block md:hidden w-full max-w-[280px] bg-white/10 border border-white/15 p-6 rounded-[24px] text-center backdrop-blur-sm">
                  <div className="flex items-center justify-center gap-2 mb-3">
                    <div className="text-[42px] font-bold text-[#FFD700] drop-shadow-[0_0_15px_rgba(255,215,0,0.6)] leading-none">4.9</div>
                  </div>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-white/80 text-[14px]">Dr. Deepika Lalwani ensures absolute clinical hygiene and uses premium sterile tools during in-clinic LARC (Copper-T / Mirena) device insertions.</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-accent mt-1 shrink-0" />
              ...
              <div className="hidden md:flex w-full md:w-[35%] lg:w-[30%] justify-center md:justify-end shrink-0 relative z-10">
                <div className="bg-white/10 border border-white/15 p-8 rounded-[24px] text-center w-full max-w-[280px] backdrop-blur-sm">
                  ...
                  <p className="text-[15px] text-white/80">Based on 105+ Reviews</p>
                </div>
              </div>
            </div>
